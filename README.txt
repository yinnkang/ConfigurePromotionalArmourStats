...
- ConfigurePromotionalArmourStatsConfig.cs: Example of ModConfig for custom mod settings;
- ConfigurePromotionalArmourStatsGeoscape.cs: Example of ModGeoscape for modifying geoscape level;
- ConfigurePromotionalArmourStatsMain.cs: Main mod class, recieves mod management and general events;
- ConfigurePromotionalArmourStatsTactical.cs: Example of ModTactical for modifying tactical level;
